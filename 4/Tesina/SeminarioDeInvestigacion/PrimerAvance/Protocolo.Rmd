...
Phillip Hans Franses\footnote{2006, Países Bajos }  propone una metodología para realizar pronosticos

El método se ilustra con la productividad de USA en $[1945.1, 2000.4]$ frente a $AR(p)$ y $AR_j(p)$
